    ...
    def __init__(self,t,y,**kwargs):
        ...
        if self.method in ['lsq','lsqfast']:
            ...
            if self.method == 'lsq':
                ...
                self.C = lstsqfft(self.t0,self.y.copy()*self.w_n,self.frq, axis=self.axis)
...
def lstsqfft(t,y,frq, axis=0):
    """
    Wrapper for harmonic_fit function
    """
    #A, P, mean = harmonic_fit(t,y,frq,axis=axis)

    #return phsamp2complex(P,A)
